...
__all__ = [
    ...
    "RandomVerticalFlip", "RandomVerticalFlipWithPoint"
    "RandomResizedCrop", "RandomSizedCrop", "FiveCrop", "TenCrop",
     "ColorJitter","ColorJitterWithPoint", "RandomRotation", "RandomRotationWithPoint", "RandomAffine",
...
class ColorJitterWithPoint(object): 
